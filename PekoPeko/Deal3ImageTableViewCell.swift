...
protocol Deal3ImageTableViewCellDelegate: class {
...
class Deal3ImageTableViewCell: UITableViewCell {
    
    static let identify = "Deal3ImageTableViewCell"
    
    weak var delegate: Deal3ImageTableViewCellDelegate?
